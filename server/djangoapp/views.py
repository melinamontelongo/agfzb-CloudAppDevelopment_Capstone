...
""" def get_dealerships(request):
    if request.method == "GET":
        ...
        # Get dealers from the URL
        dealerships = get_dealers_from_cf("https://us-south.functions.appdomain.cloud/api/v1/web/650772be-6b0d-416f-a9a5-2bae4e711b10/dealership-package/get-dealership.json")
        # Concat all dealer's short name
